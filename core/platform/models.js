...
function createPlatformState(input = {}) {
  ...
  return {
    ...
    thesisBeliefs: Array.isArray(input.thesisBeliefs) ? input.thesisBeliefs : [],
    thesisPredictions: Array.isArray(input.thesisPredictions) ? input.thesisPredictions : [],
    thesisExperiments: Array.isArray(input.thesisExperiments) ? input.thesisExperiments : [],
    thesisLoops: Array.isArray(input.thesisLoops) ? input.thesisLoops : [],
    decisionMemories: Array.isArray(input.decisionMemories) ? input.decisionMemories : [],
    decisionQualityRecords: Array.isArray(input.decisionQualityRecords) ? input.decisionQualityRecords : [],
    decisionCalibrationRecords: Array.isArray(input.decisionCalibrationRecords) ? input.decisionCalibrationRecords : [],
    truthRecords: Array.isArray(input.truthRecords) ? input.truthRecords : [],
    dailyDecisionBriefs: Array.isArray(input.dailyDecisionBriefs) ? input.dailyDecisionBriefs : [],
